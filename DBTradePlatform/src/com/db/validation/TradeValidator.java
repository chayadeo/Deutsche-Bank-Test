...
public class TradeValidator {
	...
	public static List<Trade> filterPastMaturityDateTrades(List<Trade> trades) {
	...
	public static boolean isVersionLatest(LinkedHashMap<Integer, Trade> tradeValues, Trade trade) {
	...
	public static Integer getLatestVersionInTrade(LinkedHashMap<Integer, Trade> tradeValues) {
